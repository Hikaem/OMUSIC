...
$req = $conn1->prepare('SELECT * FROM produits WHERE refcategories=5;');
$req->execute();
$req = $req->fetchAll();
	...
	<div class="categorie_body">
		...
		<a href="Produits.php?id=<?= $produits['id_produit'] ?>" class="categorie_produit_a">
			<div class="categorie_produit_div">
				<div class="categorie_produit_img"><img class="produits" src="https://srv-prj-new.iut-acy.local/RT/1projet24/upload/IMG/produits/<?= $produits['photo'] ?>"></div>
