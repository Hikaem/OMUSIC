...
$conn1=connexionBDD();  
require_once("/var/www/RT/1projet24/omusic/Admin/mdp_oublie/resetMdp.php");
...
<?php if(isset($error)){  ?>
  ...
  <form method="post" class="reset-form">
    ...
    <p>Un email va vous être envoyez avec les instructions pour mettre à niveau votre mot de passe.</p>
      ...
      <button id="btn_mdp_btn" class="btn btn-primary btn-block" type="submit"><a class="reset_mdp_a" href="../admin.php"> Retour a la page connexion</a></button>
    </form>
    <?php } ?>
  </form>
